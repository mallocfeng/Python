...
def find_parallel_rotation_angle(centers_original, centers_Actual):
...
if len(centers_Actual) >= 2:
    #第一次纠偏角度
    F_Angle = find_parallel_rotation_angle(centers_original,centers_Actual)
    #F_Angle = 0    
    ...
    FixtureLocation = step2_Position
